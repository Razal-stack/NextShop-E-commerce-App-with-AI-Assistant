...
export class CartsController {
  ...
  getUserCarts = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const carts = await this.cartsService.getUserCarts(parseInt(userId));
  ...
  getCartById = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const cart = await this.cartsService.getCartById(parseInt(id));
  ...
  createCart = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const cart = await this.cartsService.createCart(userId, date, products);
  ...
  updateCart = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const cart = await this.cartsService.updateCart(parseInt(id), userId, date, products);
  ...
  deleteCart = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const result = await this.cartsService.deleteCart(parseInt(id));

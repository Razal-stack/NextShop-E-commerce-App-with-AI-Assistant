          ...
          <>
                  ...
                  <AnimatePresence mode="popLayout">
                    {cart.map((item) => (
                      <motion.div
                        ...
                        className="flex space-x-4 p-4 rounded-xl border border-slate-100 hover:border-brand-300 hover:shadow-sm transition-all duration-200 bg-white cursor-pointer group"
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-semibold text-slate-900 line-clamp-2 mb-2 leading-snug">
                            {item.title}
                          </h4>
                          ...
                          <div className="flex items-center justify-between" onClick={(e: React.MouseEvent) => e.stopPropagation()}>
            ...
            <div className="p-6 bg-slate-50 border-t border-slate-100 flex-shrink-0">
              <div className="space-y-3 mb-6">
                ...
                {shipping > 0 && (
                  <div className="flex items-center space-x-2 text-xs text-slate-500 bg-slate-100 p-3 rounded-lg">

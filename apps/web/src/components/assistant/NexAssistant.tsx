...
export const NexAssistant: React.FC<{
  ...
  const handleVoiceClick = useCallback(() => {
    ...
    setState(prev => ({ ...prev, messages: [...prev.messages, voiceMessage] }));
  }, [uiHandler]);

  const handleImageClick = useCallback(() => {
    const imageMessage = uiHandler.createErrorMessage("Image upload is coming soon! For now, you can describe what you're looking for.");
    setState(prev => ({ ...prev, messages: [...prev.messages, imageMessage] }));
  }, [uiHandler]);
